// Generated from the Foundry build by scripts/export-abi.mjs — do not edit.
export const corpusAbi = [
  {
    "type": "constructor",
    "inputs": [
      {
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct Corpus.Submission",
        "components": [
          {
            "name": "contributor",
            "type": "address",
          ...
          },
          {
            "name": "status",
            "type": "uint8",
            "internalType": "enum Corpus.Status"
          }
        ]
      }
    ],
